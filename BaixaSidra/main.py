...
if __name__ == '__main__':
    ...
    # logging.info('---Permanente_Nova---')
    # baixa_lavouras(paramSidraNova[0], municípios, anoInicio, anoFim, paramSidraNova[1], paramSidraNova[2])
